...
// Carte géographique des parcelles — espace client (ADMIN / AGRICULTEUR).
// Seules les parcelles de l'organisation de l'utilisateur sont affichées.
// Un clic sur un marqueur ouvre le tableau de bord de la parcelle.
    ...
    <div className="flex flex-1 flex-col gap-4 p-4 md:gap-6 md:p-6">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-sm text-muted-foreground">
          Visualisez vos parcelles sur la carte. Cliquez sur un marqueur pour
          accéder au tableau de bord de la parcelle.
        </p>
        {/* Légende couleurs */}
